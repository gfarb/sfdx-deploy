...
const BUNDLE_TYPE = utils_2.MessageUtil.get('Interface');
class LightningInterface extends utils_2.TemplateCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.runGenerator(lightningInterfaceGenerator_1.default);
        });
    }
}
exports.default = LightningInterface;
LightningInterface.description = utils_2.MessageUtil.buildDescription('LightningDescription', true, [BUNDLE_TYPE]);
...
LightningInterface.help = utils_2.MessageUtil.buildHelpText(LightningInterface.examples, true);
LightningInterface.longDescription = utils_2.MessageUtil.get('LightningLongDescription', [BUNDLE_TYPE]);
LightningInterface.flagsConfig = {
    interfacename: command_1.flags.string({
        char: 'n',
        description: utils_2.MessageUtil.get('LightningNameFlagDescription', [BUNDLE_TYPE]),
        longDescription: utils_2.MessageUtil.get('LightningNameFlagLongDescription', [BUNDLE_TYPE]),
        required: true,
    }),
